...
public class Arm {
    ...
    public static void initTeleop(DcMotorEx armLeft, DcMotorEx armRight, Servo claw, Servo wrist) {
        Arm.armLeft = armLeft;
...
//        claw.setDirection(Servo.Direction.REVERSE);
    ...
    public static void initAuton(DcMotorEx armLeft, DcMotorEx armRight, Servo claw, Servo wrist) {
        Arm.armLeft = armLeft;
        Arm.armRight = armRight;
        Arm.claw = claw;
        Arm.wrist = wrist;
